...
public class TrumpsTests {
    ...
    public Player getPlayerClass() throws NotExistentValueException {
    ...
    public void NoCardsYet() throws StatusException, NotExistentValueException {
        TopTrumps tt = (TopTrumps) this.getPlayerClass();
       // int[] players_cards = tt.this.first_player.getCards();
    }
